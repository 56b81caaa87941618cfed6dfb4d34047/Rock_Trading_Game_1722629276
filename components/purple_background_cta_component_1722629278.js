            ...
            <div id="content-container" class="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
                ...
                <div id="rock-pile" class="absolute inset-0">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000" class="w-full h-full opacity-30">
                        ...
                        <path d="M0 1000 L100 950 L200 1000 L300 900 L400 950 L500 850 L600 900 L700 800 L800 850 L900 750 L1000 800 L1000 1000 Z" fill="#6B7280"/>
                        <path d="M0 1000 L75 925 L175 975 L275 875 L375 925 L475 825 L575 875 L675 775 L775 825 L875 725 L975 775 L1000 725 L1000 1000 Z" fill="#9CA3AF"/>
                    </svg>
                </div>
                <!-- Content -->
                <div id="content" class="max-w-3xl mx-auto text-center">
                    <div id="content-subtitle" class="flex"><div id="content-subtitle-text" class="flex-1 font-medium text-gray-300 pb-3" :class="contentSubtitleStyle">Discover the World of Rock Trading</div></div>
                    <div class="flex" id="content-title-container"><h2 id="content-title" class="flex-1 h2 text-white pb-4" :class="contentCtaTitleStyle">Rock Solid Investments!</h2></div>
                    <div class="flex" id="content-body-container"><p id="content-body" class="flex-1 text-lg mb-8 text-gray-200" :class="contentBodyStyle">Join our community of rock enthusiasts and start trading your favorite geological wonders today!</p></div>
                    <a id="content-cta-button" href="#0" class="btn transition duration-150 ease-in-out group bg-gradient-to-r from-gray-500 to-gray-700 text-white hover:from-gray-600 hover:to-gray-800" :class="[contentCtaButtonPrimaryStyle, contentCtaButtonGradientStyle, contentCtaButtonHoverStyle]">Start Trading <span id="content-cta-arrow" class="tracking-normal group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1 text-white" :class="contentCtaArrowStyle">-&gt;</span></a>
                </div>
            </div>
        </div>
    </section>`,
